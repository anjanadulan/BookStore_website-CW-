...
<html lang="en">
    ...
    <body>
        ...
        <div style="background: #e0ccbe; text-align: center; padding: 40px 20px; margin-top: 100px; margin-bottom: 40px;">
            <h1 style="color: #3c3633; margin: 0; font-size: 2rem;">Search Results</h1>
            <p style="color: #5d5550;">Showing results for "<strong><?php echo htmlspecialchars($search); ?></strong>"</p>
        </div>
            ...
            <div class="book-grid">
                ...
                if ($result->num_rows > 0) {
                    ...
                    <div class='no-results'>
                        ...
                        <p>We couldn't find any books matching \"<strong>" . htmlspecialchars($search) . "</strong>\".</p>
